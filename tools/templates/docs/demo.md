...
Alongside **GENERIC_PROJECT_NAME**, this project provides a **Demo version**.
...
- `GENERIC_PROJECT_CODE-demo-GENERIC_PROJECT_VERSION.zip`
...
If you want to **use GENERIC_PROJECT_NAME** → install the **extension**.  

...
This guide describes how to publish **Chrome Extension Template — Manifest V3** to the **Chrome Web Store**.
...
* Homepage URL (for example: `https://nathabee.github.io/extension-generic/`)
* Support URL (for example: `https://github.com/nathabee/extension-generic/issues`)
